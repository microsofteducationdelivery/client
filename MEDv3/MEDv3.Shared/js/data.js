(function () {
    ...
    // TODO: Замените данные своими реальными данными.
    // Вы можете добавлять данные из асинхронных источников по мере того, как они становятся доступными.
    ...
    // в качестве уникального указания на элемент, которое легко сериализовать.
    function getItemReference(item) {
        return [item.group.key, item.title];
    }

    // Эта функция возвращает список WinJS.Binding.List, содержащий только элементы, которые
    // принадлежат указанной группе.
    function getItemsFromGroup(group) {
        return list.createFiltered(function (item) { return item.group.key === group.key; });
    }

    // Получение уникальной группы, соответствующей предоставленному ключу группы.
    function resolveGroupReference(key) {
        return groupedItems.groups.getItemFromKey(key).data;
    }

    // Получение уникального элемента из предоставленного массива строк, который должен содержать
    // ключ группы и заголовок элемента.
    ...
    // Возвращает массив демонстрационных данных, который может быть добавлен в
    ...
    function generateSampleData() {
        ...
        // Эти три строки представляют закодированные изображения-заполнители. Вам потребуется задать для
        // свойства backgroundImage URL-адреса изображений в реальных данных.
        var darkGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY3B0cPoPAANMAcOba1BlAAAAAElFTkSuQmCC";
        var lightGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY7h4+cp/AAhpA3h+ANDKAAAAAElFTkSuQmCC";
        var mediumGray = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY5g8dcZ/AAY/AsAlWFQ+AAAAAElFTkSuQmCC";

        // Для отдельного отображения каждой из этих групп-примеров необходимо, чтобы они имели
        // уникальные ключи.
        var sampleGroups = [
        ...
        // Каждый из этих элементов-примеров должен иметь ссылку на отдельную
        // группу.
        var sampleItems = [
